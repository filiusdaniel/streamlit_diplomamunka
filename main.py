...
translation_dict = {
    ...
    'Like new': 'Újszerű',
    'Parking sensor':'tolatóradar',
    'USB': 'USB',
    'GPS': 'GPS',
    'Cruise control':'tempomat',
    'Lane keeping assist':'sávtartó rendszer',
    'Heated front seats':'fűthető első ülés',
    'Reverse camera':'tolatókamera',
    'Keyless start':'kulcsnélküli indítás',
    'Multifunction steering wheel':'multifunkciós kormánykerék',
    'Adaptive cruise control':'távolságtartó tempomat',
    'Rain sensor':'esőszenzor',
    'Apple CarPlay': 'Apple CarPlay',
    'Android Auto': 'Android Auto',
    'Bluetooth hands-free':'bluetooth-os kihangosító',
